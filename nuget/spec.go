...
func SpecFromFile(fn string) (*NuSpec, error) {
...
func SpecFromBytes(b []byte) (*NuSpec, error) {
	nsf := NuSpec{}
	err := xml.Unmarshal(b, &nsf)
	if err != nil {
		return nil, err
...
func SpecFromReader(r io.ReadCloser) (*NuSpec, error) {
...
func (nsf *NuSpec) ToBytes() ([]byte, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("xml.MarshalIndent err: %w", err)
	}
